...
export class DataServices {
    ...
    postData(data: any) {
        ...
        .subscribe((responce:any) => {console.log('Device with id ' + responce.name + ' is added to DB');});
    }
    ...
    removeDevice(deviceKey:string){
        const url: string =
          'https://mobile-data-36e9d-default-rtdb.firebaseio.com/devices/'+deviceKey+'.json';
